...
<section class="section news-section">
      <div class="title-container" >
        ...
        <div class="news-feild"  >
          ...
          <div class="news-content" v-show="newsData[index].isActive === true">
            ...
            <p class="news-para" v-if="newsData[index].isClick ===false">{{trucate(index)}}<span class='read-more-btn' v-on:click="newsData[index].isClick = !newsData[index].isClick" >...閱讀更多</span></p>
            <p class="news-para" v-else  v-on:click="newsData[index].isClick = !newsData[index].isClick" >{{newsData[index].content}}</p>
  ...
  <div class="chat-robot">
          ...
          <div class="chat-field" v-show = "isrobBtn === true">
            ...
            <button  class="submit-btn" v-on:click.prevent="userMeg()"><i class="fa-solid fa-paper-plane" style="color: #144433;"></i></button>

            <div class="chat-area" >
              <p class="text" v-for="item in chatData" :key="item" :class="{user:item.author === 'user',robot:item.author !== 'user'}"  >
               {{item.message}}
              </p>
          </div>
        </div>
